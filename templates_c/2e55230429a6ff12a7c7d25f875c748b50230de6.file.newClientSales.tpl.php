...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '5675135294fbcc4b0-30545025',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5135294fc78c95_45028829',
  'variables' => 
  array (
    'libraries' => 0,
    'menu' => 0,
                ...
                <fieldset class="login">
                    ...
                    <table>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><input type="text" placeholder ="Tres caracteres"disabled name="code"></td>
                            </tr>
                            <tr>
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="2">
                                <center>
                                    <input type="button" disabled name="btnSales" value="Save" onclick="validar();">
                                </center>
                            </td>
                        </tr>
                    </tfoot>
...
$_smarty_tpl->tpl_vars['foo']->first = $_smarty_tpl->tpl_vars['foo']->iteration == 1;$_smarty_tpl->tpl_vars['foo']->last = $_smarty_tpl->tpl_vars['foo']->iteration == $_smarty_tpl->tpl_vars['foo']->total;?>
  ...
  ><?php echo $_smarty_tpl->tpl_vars['countries']->value[$_smarty_tpl->tpl_vars['foo']->value][1];?>
                ...
                <fieldset >
                    ...
                    <center>    
                        <input type="button" value="Save" disabled name="btnKyc" onclick="alert('En Desarrollo')">
                    </center>
                </form>
            </fieldset>
