<?php /* Smarty version Smarty-3.1.12, created on 2013-02-23 11:17:43
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '2183150ef10d31b4d33-61909213',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_50ef10d31d8bf5_60205021',
  'variables' => 
  array (
    'libraries' => 0,
    'addModuleOption' => 0,
...
<?php if ($_valid && !is_callable('content_50ef10d31d8bf5_60205021')) {function content_50ef10d31d8bf5_60205021($_smarty_tpl) {?>
...
<script src='varios/script/addModule.js'></script>
</head>
<body onload="load('<?php echo $_smarty_tpl->tpl_vars['addModuleOption']->value;?>
      ...
      <div class="grid_4">
       <table class="grid_4">
        <tr>
          ...
          <td>
            <input type="text" name="ITAdminPassword" id="ITAdminPassword"  />
          </td>
        </tr>
        <tr>
          <td>
        ...
        <tr>
          ...
          <td>
            <input type="text" name="ITAdminUserName" id="ITAdminUserName" />
          </td>
        </tr>
        <tr>
          <td>
        ...
        <tr>
          ...
          <td>
            <input type="text" name="ITAdminName" id="ITAdminName"  />
          </td>
        </tr>
      </table>
    </div>
